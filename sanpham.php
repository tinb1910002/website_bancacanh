...
session_start();
    ...
    // $query = $pdo->query("select * from orders_details");
...
<body>
    <div class="container">
        ...
        <div class="select " style="width: 15rem;margin:10px; ">
            <div class="select_form" aria-label="Default select example" style="padding: 0rem; font-size: 23px;border: 1px solid blueviolet;">     
                <select onchange="location = this.value;" style="width: 14.6rem; height:3rem;">
                    <option style="mar" value="sanpham.php">Tất cả sản phẩm</option>
    ...
    <section class="categories" id="">              
            <div class="box-container">
                <?php foreach ($product as $key => $value) : ?>
                    <div class="box">
                        <a href="chitietsp.php?product_id=<?php echo $value['product_id'] ?>"><img src="./admin/uploads/<?php echo $value['product_img']?>" alt=""></a>
