...
<?php
    class cartegory{
        ...
        public function show_cartegogy_search($cartegory_name){
            $query = "SELECT * FROM tbl_cartegory WHERE cartegory_name LIKE '%$cartegory_name%' ORDER BY cartegory_id DESC";
            $result = $this ->db->select($query);
            return $result;
        }
    }
